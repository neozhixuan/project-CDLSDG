...
export const Card = (props) => {
  return (
    <div
      className={`w-full select-none bg-white rounded-md grid grid-cols-3 sm:grid-cols-6 sm:grid-rows-1 grid-rows-2 items-center p-4 w-full ${props.className}`}
    >
      <div className="row-start-1 col-span-1 pl-1">
        <div className="font-medium">{props.a}</div>
      </div>
      <div className="row-start-1 col-span-1 text-center">
        <span
          className={`${
            props.c > 60
              ? "bg-green-500 "
